...
<div class="card" style="width: 16rem; height: 12rem;">
  <div class="card-body">
    <svg data-bs-toggle="modal" :data-bs-target="modalId" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
